                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-center">
                            ...
                            <h3 class="fw-bold mb-0">{{ count($lga->wards) }}</h3>
                            </div>
                  ...
                  @foreach($lga->wards as $ward)
                    <div class="list-group-item py-3 bg-light border rounded-3 shadow-sm mb-2">
                        ...
                        <div class="col-md-3 text-md-end mt-3 mt-md-0">
                            <a href="/admin/states/{{$lga->state->id}}/zones/{{$lga->zone->id}}/lgas/{{$lga->id}}/wards/{{$ward->id}}/cvr" class="btn btn-outline-primary btn-sm px-3">

    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Edit PU</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h2 class="card-title">Edit PU</h2>

              <!-- No Labels Form -->
              <form action="/admin/pus/{{ $pu->id }}" method="POST" class="row g-3" style="font-size: 14px;">
                @csrf
                @method('PUT')
                <div class="col-md-6">
                  <label for="number" class="form-label fw-bold">Number:</label>
                  <input type="text" name="number" class="form-control @error('number') is-invalid @enderror" id="number" value="{{ $pu->number }}" placeholder="Enter PU's Number">
                  @error('number')
                 ...
                 <div class="col-md-6">
                  ...
                  <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" value="{{ $pu->name }}" placeholder="Enter State's Name">
                  @error('name')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
                ...
                <div class="col-md-6">
                 ...
                 <div class="col-md-12">
                  ...
                  <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description"  placeholder="Type Descrition">{{ $pu->description }}</textarea>
                  @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div> 

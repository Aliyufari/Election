    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h2 class="card-title">Edit Supervisor</h2>

              <!-- No Labels Form -->
              <form action="/admin/supervisors/{{$user->id}}" method="POST" enctype="multipart/form-data" class="row g-3" style="font-size: 14px;">
                @csrf
                @method('PUT')
                <div class="col-md-6">

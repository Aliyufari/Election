    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h2 class="card-title">Create Supervisor</h2>

              <!-- No Labels Form -->
              <form action="/admin/supervisors/create" method="POST" enctype="multipart/form-data" class="row g-3" style="font-size: 14px;">
                @csrf
                <div class="col-md-6">

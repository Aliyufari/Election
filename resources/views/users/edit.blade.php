        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- No Labels Form -->
              <form action="/admin/users/{{ $user->id }}" method="POST" enctype="multipart/form-data" class="row g-3" style="font-size: 14px;">
                @csrf
                @method('PUT')
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" name="phone" class="form-control @error('phone') is-invalid @enderror" id="phone" value="{{ $user->phone }}" placeholder="Enter Phone Number">
                  @error('phone')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
                <div class="col-12">
                  ...
                  @error('image')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                  <img src="{{ asset('storage/' . $user->image)}}" style="max-width:120px; margin-top: 10px;" alt="Profile">
                </div>
                <div class="col-md-12">

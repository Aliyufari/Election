    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Ratechs</li>
          <li class="breadcrumb-item active">Edit Ratech</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h2 class="card-title">Edit Ratech</h2>

              <!-- No Labels Form -->
              <form action="/admin/ratechs/{{$user->id}}" method="POST" enctype="multipart/form-data" class="row g-3" style="font-size: 14px;">
                @csrf
                @method('PUT')
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" id="username" value="{{$user->username}}" placeholder="Create Username">
                  @error('username')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
                <div class="col-md-6">
                  ...
                  <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" value="{{$user->email}}" placeholder="Email Address">
                  @error('email')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" name="phone" class="form-control @error('phone') is-invalid @enderror" id="phone" value="{{$user->phone}}" placeholder="Phone Number">
                  @error('phone')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>

    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Create Ratech</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h2 class="card-title">Create Ratech</h2>

              <!-- No Labels Form -->
              <form action="/admin/ratechs/create" method="POST" enctype="multipart/form-data" class="row g-3" style="font-size: 14px;">
                @csrf
                <div class="col-md-6">
